...
class PlanType2ConfigSection: PlanTableViewSectionType {
    
    let model = PlanType2ConfigModel()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.ns.dequeueCell(PlanType2ConfigCell.self, for: indexPath)
