...
class PlanType2GrowthSection: PlanTableViewSectionType {
    
    let model = PlanType2GrowthModel()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.ns.dequeueCell(PlanType2GrowthCell.self.self, for: indexPath)
