...
class PlanType2NewPlanSection: PlanTableViewSectionType {
    
    let model = PlanType2NewPlanModel()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.ns.dequeueCell(PlanType2NewPlanCell.self, for: indexPath)
